...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="./layouts/statistic_page.php">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Statistik</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="./layouts/table_page.php">
          <i class="fas fa-fw fa-table"></i>
          <span>Daftar Tamu</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="./layouts/teacher_page.php">
          <i class="fas fa-fw fa-user"></i>
          <span>Daftar Guru</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="./layouts/admin_page.php">
